...
public:
  ...
  Settings::TeamColor firstFieldPlayerColour = static_cast<Settings::TeamColor>(-1); /**< Color of the first team. */
  Settings::TeamColor secondFieldPlayerColour = static_cast<Settings::TeamColor>(-1); /**< Color of the second team. */
  Settings::TeamColor firstGoalkeeperColour = static_cast<Settings::TeamColor>(-1); /**< Color of the first team. */
  Settings::TeamColor secondGoalkeeperColour = static_cast<Settings::TeamColor>(-1); /**< Color of the second team. */
