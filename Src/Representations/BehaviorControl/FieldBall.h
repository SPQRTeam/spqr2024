 ...
 * It is better to use the functions below than variables, because functions return the best possible output,
 * while you have to pay attention to choose the right variable according to the specific case
 */
STREAMABLE(FieldBall,
{
  ...
  (bool)(false) isInsideGoalRectangle,
