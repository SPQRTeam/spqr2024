...
std::list<std::string> File::getConfigDirs()
{
  ...
  if(Global::settingsExist())
  {
    ...
    dirs.push_back(configDir + "Robots/" + Global::getSettings().headName + "/");   // dont trust the framework
    dirs.push_back(configDir + "Robots/" + Global::getSettings().bodyName + "/");   // dont trust the framework
