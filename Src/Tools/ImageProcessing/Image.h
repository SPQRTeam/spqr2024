...
//#include "Util/Buildchain/V6/gcc/include/opencv/include/opencv2/core/core.hpp"
...
//VINC
  ...
  {
    Pixel p = *(image + y * width + x / 2);
    //if(!(x & 1)) // TO DO GRAZIANO: ho commentato ste du righe ma non so se erano essenziali 
    //  p.y = p.yCbCrPadding;
    return p;
  }
//END VINC
