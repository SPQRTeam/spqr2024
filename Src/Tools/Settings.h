...
public:
   ...
   * @param fieldPlayerColour 
   * @param goalkeeperColour 
   ...
   */
  Settings(const std::string& headName, const std::string& bodyName, int teamNumber, TeamColor fieldPlayerColour, TeamColor goalkeeperColour, int playerNumber, const std::string& location, const std::string& scenario, int teamPort, unsigned char magicNumber);
  ...
  static constexpr int highestValidPlayerNumber = SPQR_MAX_PLAYER_NUMBER; /**< No player can have a number greater than this */
  ...
  (TeamColor)(numOfTeamColors) fieldPlayerColour, /**< The color of our field players. Use theOwnTeamInfo.fieldPlayerColour instead. */
  (TeamColor)(numOfTeamColors) goalkeeperColour, /**< The color of our goalkeeper. Use theOwnTeamInfo.goalkeeperColour instead. */
