...
void ExtendedGameInfoProvider::update(ExtendedGameInfo& extendedGameInfo)
{
  ...
  if(theGameInfo.gamePhase != GAME_PHASE_PENALTYSHOOT)
  {
    ...
    else if(penaltyLastFrame != PENALTY_NONE && penaltyLastFrame != PENALTY_SPL_ILLEGAL_MOTION_IN_SET && penaltyLastFrame != PENALTY_SPL_ILLEGAL_MOTION_IN_STANDBY && theRobotInfo.penalty == PENALTY_NONE &&
