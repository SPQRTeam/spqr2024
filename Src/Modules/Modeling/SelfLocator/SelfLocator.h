...
{,
  ...
  {,
    ...
    (float)  returnFromPenaltyYOffset,               /**< When poses are generated after returning from a penalty, the robot is placed behind the sideline. The absolute value of this offset is defined by this parameter. */
