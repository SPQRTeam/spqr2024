...
void FieldBallProvider::update(FieldBall& fieldBall)
{
  ...
  checkIfBallIsInsideGoalRectangle(fieldBall);
...
void FieldBallProvider::checkIfBallIsInsideGoalRectangle(FieldBall& fieldBall)
{
  fieldBall.isInsideGoalRectangle = false;
...
void FieldBallProvider::checkIfBallIsInsideDefenderCircle(FieldBall& fieldBall)
{
  ...
  fieldBall.isInsideGoalieCircle = (ballPos - goalCenter).norm() < 1000 || (endBallPos - goalCenter).norm() < 1000;
