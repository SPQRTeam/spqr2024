...
{
  params.reserve(10); // Where this 10 comes from? kmc currently avaliable: 7
...
bool KickPhase::isDone(const MotionRequest& motionRequest) const
{
  ...
  bool isKickForward = currentKickRequest.kickMotionType == KickRequest::kickForwardFast || currentKickRequest.kickMotionType == KickRequest::kickForwardFastLong 
                                                            || currentKickRequest.kickMotionType == KickRequest::ottoMetriKick || currentKickRequest.kickMotionType == KickRequest::lobKick
                                                            || currentKickRequest.kickMotionType == KickRequest::kickTest;
...
void KickPhase::calcJoints(const MotionRequest&, JointRequest& jointRequest, Pose2f& odometryOffset, MotionInfo& motionInfo)
{
  ...
  if((currentKickRequest.kickMotionType == KickRequest::kickForwardFast || currentKickRequest.kickMotionType == KickRequest::kickForwardFastLong ||
      currentKickRequest.kickMotionType == KickRequest::ottoMetriKick || currentKickRequest.kickMotionType == KickRequest::lobKick || currentKickRequest.kickMotionType == KickRequest::kickTest) && data.phaseNumber < 2)
