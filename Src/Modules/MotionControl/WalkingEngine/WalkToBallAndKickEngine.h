...
{,
  ...
  {,
    ...
    (Rangef)(Rangef(45.f, 55.f)) ottoMetriYThreshold, /** Daniele */
    (Rangef)(Rangef(190.f, 210.f)) ottoMetriXThreshold, /** Daniele */
    (float)(10.f)                  ottoMetriLooseness, /** Daniele */
    (Rangef)(Rangef(45.f, 55.f)) testYThreshold, /** Daniele */
    (Rangef)(Rangef(215.f, 225.f)) testXThreshold, /** Daniele */
